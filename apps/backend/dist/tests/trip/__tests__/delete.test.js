...
(0, globals_1.describe)("DELETE /api/trip/delete/:tripId", () => {
    //1. successful trip deletion
    (0, globals_1.it)("should delete a trip", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, globals_1.expect)(res.body.message).toBe("Alert deleted successfully");
        (0, globals_1.expect)(prismaMock.alert.delete).toHaveBeenCalled();
    }));
    (0, globals_1.it)("should fail for invalid tripId", () => __awaiter(void 0, void 0, void 0, function* () {
        prismaMock.user.findUnique.mockResolvedValue({
            userId: "123",
            username: "user1",
            mobile: "9999999999",
    ...
    (0, globals_1.it)("should fail to delete alert if it does not belong to user", () => __awaiter(void 0, void 0, void 0, function* () {
        prismaMock.user.findUnique.mockResolvedValue({
            userId: "123",
            username: "user1",
            mobile: "9999999999",
